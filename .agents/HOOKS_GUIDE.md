...
| **8. خطاف مراجعة وتحديث المكتبات** | `[github-talent-scout]`, `[code-architect]` | الأساسي: `Gemini 3.7 Flash (High)` <br> البديل: `Gemini 3.6 Flash (Medium)` | `"تحديث الاعتماديات"`, `"تحديث المكتبات"` | فحص ملفات Gradle وتحديث المكتبات والاعتماديات القديمة وتجنب التعارضات. |
